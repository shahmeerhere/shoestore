...
export default function WomenPage() {
  ...
  const handleAddToCart = (shoe) => {
    ...
    const selectedColor = selectedColors[shoe.id] || defaultColor;
  ...
  const handleWishlist = (shoeId) => {
    setWishlist((prev) => {
      ...
      if (newWishlist.has(shoeId)) newWishlist.delete(shoeId);
      else newWishlist.add(shoeId);
      return newWishlist;
    });
  };
      ...
      <div className="bg-gradient-to-r from-pink-900 to-purple-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Elegant footwear that combines style, comfort, and sophistication
          </p>
                ...
                >
                  ...
                  <div className="relative aspect-square overflow-hidden">
                    <Link href={`/products/${shoe.id}`}>
                      <img
                        src={shoe.colors[selectedColor]?.image}
